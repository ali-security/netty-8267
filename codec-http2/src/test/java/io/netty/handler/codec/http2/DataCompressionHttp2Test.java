...
public class DataCompressionHttp2Test {
    ...
    @Test
    public void brotliEncodingLargeMessageWithBufferLimit() throws Exception {
        ...
        try {
            ...
            if (cause == null) {
                ...
                assertTrue(cause.getCause().getMessage().contains("maximum size") ||
                        cause.getCause().getMessage().contains("too large"));
            }
        } finally {
            data.release();
        }
